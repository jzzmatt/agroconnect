...
export class AcademyAuthoringService {
  ...
  public static async getCourseEditorTree(
    ...
    return {
      ...
      thumbnail_storage_path: course?.thumbnail_storage_path ?? null,
      thumbnail_original_filename: course?.thumbnail_original_filename ?? null,
      thumbnail_mime_type: course?.thumbnail_mime_type ?? null,
      thumbnail_size: course?.thumbnail_size ?? null,
