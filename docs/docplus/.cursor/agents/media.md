# Media Infrastructure Agent

## Mission
Own: media abstraction, ImageKit, Bunny integration boundary, uploads, metadata, webhooks. ImageKit for product/application media; Bunny only Academy.
